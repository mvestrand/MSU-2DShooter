...
//     [Serializable]
//     [NotKeyable]
//     public class ControlXPlayableAsset : PlayableAsset, IPropertyPreview, ITimelineClipAsset
//     {
...
//                 Debug.Log($"go={go} \t src={sourceObject}");
...
//             return ToDouble(DoubleToDiscreteTime(time) + 1);
//         }
