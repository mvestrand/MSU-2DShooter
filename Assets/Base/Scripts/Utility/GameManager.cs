...
public class GameManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Possible game difficulty settings
    /// </summary>
    public enum GameDifficulty { Normal = 0 }
    [Tooltip("The current game difficulty")]
    [SerializeField] private GameDifficulty difficulty = GameDifficulty.Normal;
    public static GameDifficulty Difficulty {
        get { return instance.difficulty;  }
        set { instance.difficulty = value; }
    }
    public static int DifficultyOptionsCount() {
        return System.Enum.GetValues(typeof(GameDifficulty)).Length;
    }
    public static string[] DifficultyOptions() {
