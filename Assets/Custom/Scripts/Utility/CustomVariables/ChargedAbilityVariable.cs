...
public class ChargedAbilityVariable : ScriptableVariable<ChargedAbility> {
    [SerializeField] private Color _debugColor = Color.white;
    public Color DebugColor { get { return _debugColor; } }
}

[Serializable]
public class ChargedAbilityReference : ScriptableReference<ChargedAbilityVariable, ChargedAbility> {}
